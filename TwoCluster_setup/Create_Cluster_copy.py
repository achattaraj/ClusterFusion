# -*- coding: utf-8 -*-
"""
Created on Tue Jan 31 15:49:52 2023
...
def copyCoorBlock(cBlock, dist=300):
    ...
    print(f'Cluster1 : {Rg1} A, Cluster2: {Rg2} A')
...
file = 'C:/Users/chatt/OneDrive - Harvard University/Python_HU/lmp_analysis/Github_ClusterFusion/TwoCluster_setup/final_state_N200_S3Ns05kT.DATA'
...
ofile = 'C:/Users/chatt/OneDrive - Harvard University/Python_HU/lmp_analysis/Github_ClusterFusion/TwoCluster_setup/IC_twoCluster_S3Ns05kT.DATA'
writeFile(ofile, mass_block, cB, bB, aB, centers, Rg)
